...
old_header_left = """        <div className="flex items-center gap-1">
          <span className="font-sans font-bold text-lg md:text-xl text-white tracking-tight">Karthikraj</span>
          <span className="font-sans font-medium text-lg md:text-xl text-[#3B82F6] tracking-tight">Nadar</span>
        </div>"""
...
new_header_left = """        <div className="flex items-center gap-6">
          <div className="flex items-center font-sans text-lg md:text-xl font-bold tracking-tight text-white uppercase">
            ...
            <span className="ml-2">KARTHIKRAJ_NADAR</span>
          </div>
          <button 
